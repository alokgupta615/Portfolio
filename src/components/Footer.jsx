...
export default function Footer() {
  return (
    <footer className="bg-slate-900 text-white py-12">
      <div className="w-full h-[1px] bg-gradient-to-r from-transparent via-emerald-500 to-transparent my-10"></div>
      <div className="container mx-auto px-6">
        <div className="flex flex-col items-center">
          ...
          <p className="text-slate-400 text-center flex items-center gap-2">
            Made with{" "}
            <Heart className="w-4 h-4 text-emerald-500 fill-current" /> by Alok
            Kumar Gupta
          </p>
